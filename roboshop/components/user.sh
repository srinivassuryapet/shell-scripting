...
sed -i -e 's/MONGO_ENDPOINT/mongodb-ss.srinivassuryapet.ml/' -e 's/REDIS_ENDPOINT/redis-ss.srinivassuryapet.ml/' /home/roboshop/user/systemd.service && mv /home/roboshop/user/systemd.service /etc/systemd/system/user.service
Stat $?
